...
import com.hypixel.hytale.server.core.util.EventTitleUtil; // Import is accessible according to documentation
...
/**
 * Command to activate the ULTRA optimization preset.
...
public class HyFineUltraCommand extends AbstractPlayerCommand {
     ...
     *
     * @param name The name of the command (e.g., "hyfineultra").
    ...
    protected void execute(@Nonnull CommandContext commandContext,
                           ...
                           @Nonnull World world) {
        // Apply the ULTRA optimization preset
        ...
        EventTitleUtil.showEventTitleToPlayer(
                playerRef,
                Message.raw("ULTRA Mode Activated"), // Title message
                Message.raw("Preset Changed"),       // Subtitle message
                true                               // Centered flag
        );

        // Optional: Send a chat message as well for confirmation
        playerRef.sendMessage(Message.raw("HyFine: ULTRA preset activated."));
    }
}
